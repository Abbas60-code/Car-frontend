          ...
          <div className="tab-content-container fade-in">
            ...
            <div className="milestone-display-card">
              <div className="milestone-content-left">
                <div className="milestone-year-badge">{MILESTONES[activeMilestone].year} MILESTONE</div>
                <h3 className="milestone-title">{MILESTONES[activeMilestone].title}</h3>
                <p className="milestone-desc">{MILESTONES[activeMilestone].desc}</p>
            ...
            <div className="showrooms-layout">
              ...
              <div className="showrooms-list">
                {SHOWROOMS.map((s) => (
                  <div 
                    key={s.id} 
                    className={`showroom-list-item ${selectedShowroom.id === s.id ? 'active' : ''}`}
              ...
              <div className="showroom-preview-card">
                <div className="showroom-img-container">
                  <img src={selectedShowroom.image} alt={selectedShowroom.name} className="showroom-img" />
                  <div className="showroom-img-overlay">
                    <span className="showroom-city-tag">{selectedShowroom.city}</span>
                  </div>
                </div>
                ...
                <div className="showroom-body">
                  ...
                  <div className="featured-models-box">
                    ...
                    <p className="fm-text">{selectedShowroom.featured}</p>
                  </div>

                  <div className="showroom-actions">
                    <button className="btn-primary" onClick={() => handleShowroomVisit(selectedShowroom)}>
                      <Calendar size={16} style={{ marginRight: '6px' }} />
                      Book Private Viewing
                    </button>
                    <a href={`tel:${selectedShowroom.phone}`} className="btn-secondary">
